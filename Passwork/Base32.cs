...
namespace Passwork
{
    public static class Base32
    {
        ...
        //Coming from JS Connector, but could not find a use case why/when it should be needed.
        ...
        /// <summary>
        /// Alphabet as used by Passwork JS Connector.
        /// </summary>
        private const string Base32Alphabet = "0123456789abcdefghjkmnpqrtuvwxyz";
        ...
        public static byte[] FromBase32String(string base32String)
        {
            ...
            string base32StringLowerCase = base32String.ToLowerInvariant();

            // Prepare output byte array
            byte[] outputBytes = new byte[base32StringLowerCase.Length * OutByteSize / InByteSize];
            ...
            while (outputBytePosition < outputBytes.Length)
            {
                ...
                int currentBase32Byte = Base32Alphabet.IndexOf(base32StringLowerCase[base32Position]);
